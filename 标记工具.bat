...
echo ============================================
echo   Blog Tag Editor
echo   Node: %NODE_EXE%
echo ============================================
echo.
echo Starting server...

powershell -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "Start-Process -WindowStyle Hidden -FilePath '%NODE_EXE%' -ArgumentList 'scripts\tag-editor.mjs' -WorkingDirectory '%~dp0'"
...
echo.
echo Tag Editor is running at %URL%
